...
def r_ply(type_):
    ...
    mar = InlineKeyboardMarkup(
        [
            ...
            [       
                InlineKeyboardButton("اخفاء القائمة ❎", "cls")
            ]        
        ]
    )
    return mar
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("☯︎GROUP☯︎", url=f"https://t.me/Mk_Elkeatib_Mk")
                ],
            ]
        )
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("⌯ 2️⃣ ⌯", callback_data=f'plll 2|{query}|{user_id}'),
                    ],
                    [
                        InlineKeyboardButton("⌯ 3️⃣ ⌯", callback_data=f'plll 3|{query}|{user_id}'),
                    ],
